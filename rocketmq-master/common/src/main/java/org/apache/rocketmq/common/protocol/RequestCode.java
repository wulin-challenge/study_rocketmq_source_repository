...
public class RequestCode {
    ...
    /**
     * 通过msgId查询消息
     * <p> 举例: 需要注意的是  此处的msgId = "C0A8C70100002A9F000000000000331F"; 
     * 其中该msgId的[0-8]位表示主机ip,[8-16]表示是端口号,[16-32]表示的消息的offset,即物理偏移量
     */
    ...
    /**
     * 通过主题从nameServer上得到broker的路由信息
     * <p> 说明: 路由信息都封装在 TopicRouteData 类中
     */
