...
public class BrokerConfig {
     ...
     * value is 1.
     * 
     * <p> 发送消息线程池的线程号，因为自4.0.x以来默认使用自旋锁，默认值为1。
     * 
     */
    ...
    /**
     * Switch of filter bit map calculation.If switch on:
     * <p> map集合过滤计算开关,如果开关打开
     * 
     * <p> 1. Calculate filter bit map when construct queue.
     * <p> 1.构造队列时计算过滤map。
     * 
     * <p> 2. Filter bit map will be saved to consume queue extend file if allowed.
     * <p> 2.如果允许，将保存过滤map以使用队列扩展文件。
     */
