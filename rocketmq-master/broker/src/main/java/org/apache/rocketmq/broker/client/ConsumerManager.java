...
public class ConsumerManager {
    ...
    /**
     * 该值来至于客户端自定义心跳更新,自定义心跳是  MQClientInstance.this.sendHeartbeatToAllBrokerWithLock();
     * 
     * 清空该值来至于 IdleStateHandler 触发了 userEventTriggered 函数 ,执行了closeChannel(ctx.channel());
     */
