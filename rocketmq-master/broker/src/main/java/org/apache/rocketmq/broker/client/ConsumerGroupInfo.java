...
public class ConsumerGroupInfo {
    ...
    /**
     * 更新客户端 channel
     * @param infoNew 新的客户端channel
     * @param consumeType 消费者类型pull/push
     * @param messageModel 消息模式broadcast(广播)/clustering(集群)
     * @param consumeFromWhere 消费点
     * @return
     */
