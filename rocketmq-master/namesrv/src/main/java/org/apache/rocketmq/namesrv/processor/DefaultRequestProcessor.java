...
public class DefaultRequestProcessor implements NettyRequestProcessor {
    ...
    public RemotingCommand getRouteInfoByTopic(ChannelHandlerContext ctx,
        ...
        /**
         *  调用 RouterlnfoManager 的方法,从路由
         *  表 topicQueueTable 、 brokerAddrTable 、filterServerTable 中分 别填
         *  充 TopicRouteData 中的 List<Queu 巳Data＞、 List<BrokerData＞和filterServer 地址表 。
         */
